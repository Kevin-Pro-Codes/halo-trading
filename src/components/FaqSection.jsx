...
const FaqSection = () => {
  ...
  className={`btn btn-sm px-2 py-1 fw-bold ${selectedCategory === category.id ? `btn-${category.variant}` : `btn-outline-${category.variant}`}`}
>
  <i className={`bi ${category.icon}`}></i>
  <span className="ms-0">{category.name}</span>
</button>
              ))}
            </div>
          </div>
  ...
  <div className="col-sm-7">
    <div className="row g-4">
      <div className="col-md-4 text-center">
        <div className="btn-outline-secondary shadow-sm"> {/* Removed h-1 */}
...
{/* CTA Section - Narrower Box */}
<div className="row justify-content-center mt-4">
  <div className="col-md-8 col-lg-6 col-xl-3"> {/* Reduced width */}
    {/* Narrow box outline */}
    <div className="border border-dark rounded-2 p-3 bg-white mx-auto" style={{maxWidth: '500px'}}>
      
      <div className="text-center mb-2">
        <div className="bg-primary bg-opacity-10 p-1 rounded-circle d-inline-block mb-1">
          <i className="bi bi-question-circle-fill text-primary"></i>
        </div>
        <h4 className="fw-bold mb-1 h5">Still Need Help?</h4>
