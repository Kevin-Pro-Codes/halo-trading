...
const ConverterSection = () => {
  ...
  // Removed suggestive quick amounts
  // const quickAmounts = [0.1, 0.5, 1, 5, 10]; // REMOVED
...
<div className="text-center mb-12">
  <div className="flex items-center justify-center gap-3 mb-4">
    {/* Bitcoin grande com estilo inline - ISSO VAI FUNCIONAR */}
    <div 
      style={{ 
        fontSize: '6rem', /* 80px - MUITO GRANDE */
    ...
    <h2 className="display-6 display-lg-5 fw-bold mb-0 text-white">
      Bitcoin Converter
    </h2>    
  </div>
  <p className="text-gray-400 text-lg">
    Real-time Bitcoin to USD conversion with live market data
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg border border-white p-6">
 {/* Bootstrap - Tabs centralizadas */}
<div className="d-flex justify-content-center gap-2 mb-4 p-2 bg-dark rounded-1 border border-secondary">
  <button
    className={`px-4 py-2 fw-semibold transition-all rounded-1 ${
      activeTab === 'converter' 
...
<div className="space-y-6">
  <div className="converter-input-group">
    <label className="block text-black mb-2 text-sm font-medium"> {/* Mudei text-gray-400 para text-black */}
      Bitcoin (BTC)
    </label>
  ...
  <div className="converter-input-group">
    <label className="block text-black mb-2 text-sm font-medium"> {/* Já está text-black */}
      US Dollar (USD)
    </label>
    <div className="relative">
      <input
        ...
        $
                ...
                <div className="mt-8 pt-6 border-t border-gray-700">
                  <div className="flex items-center justify-between">
                    <div className="text-black">Exchange Rate</div>
                    <div className="text-2xl font-bold text-black">
                      1 ₿ = {formatCurrency(btcPrice)}
                    </div>
                  </div>
                  
                {/* Refresh Button - Outline preto, fundo branco */}
<div className="flex justify-end mt-4">
 <button className="btn btn-white border border-dark text-dark fw-bold rounded-1 px-4 py-2">
  <RefreshCw className="me-2" /> Refresh
</button>
</div>
                </div>
              </div>
            ...
            <div className="conversion-history">
              <h3 className="text-xl font-bold mb-4 text-white">Recent Conversions</h3>
