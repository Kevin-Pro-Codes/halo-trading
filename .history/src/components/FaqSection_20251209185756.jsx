    ...
    <div className="row g-4">
      <div className="col-md-4 text-center">
        <div className="card border-0 shadow-sm">
          <div className="card-body p-3 p-sm-4"> {/* Reduced p-4 to p-3 */}
            <div className="bg-primary bg-opacity-10 p-3 rounded-circle d-inline-block mb-2"> {/* Reduced mb-3 to mb-2 */}
              <i className="bi bi-headset text-primary fs-4"></i>
            </div>
            <h3 className="fw-bold mb-1">24/7 Support</h3> {/* Reduced mb-2 to mb-1 */}
            <p className="text-muted mb-0">Round-the-clock assistance for all users</p>
          </div>
        </div>
      </div>
      {/* Repeat for other cards with same padding adjustments */}
    </div>
  </div>
</div>
