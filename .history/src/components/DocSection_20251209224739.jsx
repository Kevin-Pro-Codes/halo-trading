...
<div className="row justify-content-center mb-5">
  <div className="col-lg-10">
    ...
    <div className="row g-2"> {/* Reduced from g-3 to g-2 */}
        ...
        <div key={index} className="col-6 col-md-4 col-lg-2">
          <a href={link.link} className="text-decoration-none">
            <div className={`card border-0 shadow-sm h-100 transition ${link.popular ? 'border-primary border-2' : ''}`}>
              <div className="card-body p-2 text-center"> {/* Reduced from p-3 to p-2 */}
                <div className={`bg-${link.popular ? 'primary' : 'light'} bg-opacity-10 p-1 rounded-circle d-inline-block mb-1`}> {/* Reduced from p-2 to p-1 */}
