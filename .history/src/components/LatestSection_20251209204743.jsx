  ...
  return (
    <section className="py-5 bg-dark text-white">
      <div className="container">
        ...
        {/* Updates Grid - FIXED FOR CLOSER CARDS */}
                  ...
                  <div className="card h-100 border-secondary bg-white hover-lift transition-all">
                    <div className="card-body p-4 d-flex flex-column">
                      ...
                      <div className="mb-3 flex-grow-1">
                        <h4 className="fw-bold mb-2 text-black">{update.title}</h4>
                        <p className="text-black mb-0">{update.description}</p>
                      </div>
        ...
        {/* Two Boxes at Bottom - CLOSER TOGETHER */}
        ...
        {/* View All Button - Adjusted spacing */}
        <div className="row justify-content-center mt-3">
