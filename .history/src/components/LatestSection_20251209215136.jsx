  ...
  <div className="col-12 col-lg-10">
    <div className="row g-3 g-lg-4 justify-content-center">
      ...
      <div className="col-12 col-lg-6">
        <div className="card border-warning bg-white h-100" style={{ borderRadius: '10px' }}>
          <div className="card-body p-3 p-lg-4 d-flex flex-column">
            ...
            <div className="mt-auto">
              ...
              <div className="mb-3">
                <input
                  type="email"
                  className="form-control border-secondary w-100 py-2 py-lg-3"
              ...
              <div className="text-center mb-3">
                <button className="btn btn-primary px-5 py-2 py-lg-3">
                  Subscribe
                </button>
              </div>
