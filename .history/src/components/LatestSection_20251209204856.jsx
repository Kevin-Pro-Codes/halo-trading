  ...
  return (
    <section className="py-5 bg-dark text-white">
      <div className="container">
          ...
          <div className="col-lg-10">
            <div className="d-flex flex-wrap justify-content-center gap-2 mb-4">
              {categories.map((category) => (
                <button key={category.id} className="btn btn-outline-primary btn-sm px-3 py-2">
        ...
        {/* TWO BOTTOM BOXES (CLOSER TOGETHER) */}
        <div style={{ width: "100%", marginTop: "3rem", marginBottom: "2rem" }}>
          <div style={{
            display: "flex",
            gap: "10px",      // ← REDUCED GAP (was 30px)
            justifyContent: "center",
          }}>

            {/* LEFT BOX */}
            <div style={{
              minWidth: "480px",   // ← REDUCED WIDTH
              maxWidth: "550px",
            }}>
