      ...
      <div className="col-md-4">
        <div className="card border-light shadow-sm h-100">
          <div className="card-body p-2 text-center">
            <div className="bg-primary bg-opacity-10 p-2 rounded-circle d-inline-flex align-items-center justify-content-center mb-1" style={{width: '40px', height: '40px'}}>
              <i className="bi bi-headset text-primary fs-6"></i>
            </div>
            <h6 className="fw-bold mb-0">24/7 Support</h6>
            <p className="text-muted small mb-0 mt-1">Always available</p>
          </div>
        </div>
      </div>
      <div className="col-md-4">
        <div className="card border-light shadow-sm h-100">
          <div className="card-body p-2 text-center">
            <div className="bg-success bg-opacity-10 p-2 rounded-circle d-inline-flex align-items-center justify-content-center mb-1" style={{width: '40px', height: '40px'}}>
              <i className="bi bi-check-circle text-success fs-6"></i>
            </div>
            <h6 className="fw-bold mb-0">98% Satisfaction</h6>
            <p className="text-muted small mb-0 mt-1">Top-rated service</p>
          </div>
        </div>
      </div>
      <div className="col-md-4">
        <div className="card border-light shadow-sm h-100">
          <div className="card-body p-2 text-center">
            <div className="bg-warning bg-opacity-10 p-2 rounded-circle d-inline-flex align-items-center justify-content-center mb-1" style={{width: '40px', height: '40px'}}>
              <i className="bi bi-lightning text-warning fs-6"></i>
            </div>
            <h6 className="fw-bold mb-0">2 Min Response</h6>
            <p className="text-muted small mb-0 mt-1">Fast support</p>
          </div>
        </div>
      </div>
    </div>
