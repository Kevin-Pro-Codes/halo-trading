  ...
  return (
    <section className="py-5 bg-dark text-white">
      <div className="container">
        ...
        {/* Two Boxes at Bottom - BIGGER CARDS */}
        <div className="container-fluid px-0 mt-5 mb-5">
          <div className="row g-4 justify-content-center mx-0">
            {/* Left Box: Newsletter - BIG */}
            <div className="col-xxl-8 col-xl-8 col-lg-7">
              <div className="card border-primary bg-white h-100" style={{
                minHeight: '420px',
                borderRadius: '15px'
              }}>
                <div className="card-body p-5 d-flex flex-column">
                  <div className="d-flex align-items-center mb-4">
                    <div className="bg-primary bg-opacity-10 p-3 rounded-circle me-4 d-flex align-items-center justify-content-center" style={{ width: '65px', height: '65px' }}>
                      <i className="bi bi-bell-fill text-black fs-2"></i>
                    </div>
                    <div>
                      <h2 className="fw-bold mb-2 text-black">Stay Updated</h2>
                  ...
                  <div className="mt-auto">
                    ...
                    <p className="text-black fs-5 mb-0">
