...
const LatestSection = () => {
  ...
  return (
    <section className="py-5 bg-dark text-white">
      ...
      {/* Two Boxes at Bottom - OUTSIDE CONTAINER - BIGGER */}
      <div style={{
        width: '100vw',
        ...
        <div style={{
          ...
          {/* Left Box: Newsletter - MUCH BIGGER */}
          <div style={{
            flex: '2',
            minWidth: '900px',  // Much wider
            backgroundColor: 'transparent'
          }}>
            <div className="card border-primary bg-white" style={{
              minHeight: '450px',  // Taller
              borderRadius: '15px',
              padding: '35px'  // More padding
            }}>
              <div className="card-body p-0 d-flex flex-column">
                <div className="d-flex align-items-center mb-5">
                  <div className="bg-primary bg-opacity-10 rounded-circle p-4 me-4 d-flex align-items-center justify-content-center" style={{ width: '80px', height: '80px' }}>
                    <i className="bi bi-bell-fill text-black fs-1"></i> {/* fs-1 is huge */}
                  </div>
                  <div>
                    <h1 className="fw-bold mb-3 text-black" style={{ fontSize: '2.5rem' }}>Stay Updated</h1>
                    <p className="text-black fs-4 mb-0">Get the latest news in your inbox</p>
                  </div>
                </div>

                <p className="text-black mb-5 fs-4" style={{ fontSize: '1.3rem' }}>
                  Subscribe to our newsletter and be the first to know about new features, updates, and trading insights.
                </p>

                <div className="mt-auto">
                  <div className="input-group mb-4" style={{ height: '75px' }}>
                    <input
                      type="email"
                  ...
                  <p className="text-black fs-4 mb-0" style={{ fontSize: '1.1rem' }}>
      ...
      {/* Reopen container for View All button */}
      <div className="container">
        {/* View All Button */}
