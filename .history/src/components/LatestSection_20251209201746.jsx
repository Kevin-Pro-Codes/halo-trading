...
{/* Two Boxes at Bottom - WORKING VERSION */}
<div className="container-fluid px-0"> {/* Full width container */}
  <div className="row g-4 justify-content-center mx-0"> {/* Remove horizontal margins */}
    {/* Left Box: Newsletter - BIG */}
    <div className="col-xxl-8 col-xl-8 col-lg-7"> {/* Use Bootstrap grid for better control */}
      <div className="card border-primary bg-white" style={{
        ...
        <div className="card-body p-4 d-flex flex-column">
          <div className="d-flex align-items-center mb-4">
            <div className="bg-primary bg-opacity-10 p-3 rounded-circle me-4 d-flex align-items-center justify-content-center" style={{ width: '60px', height: '60px' }}>
              <i className="bi bi-bell-fill text-black fs-2"></i> {/* fs-2 is bigger */}
            </div>
            <div>
              <h3 className="fw-bold mb-2 text-black">Stay Updated</h3> {/* h3 instead of h4 */}
              <p className="text-black fs-5 mb-0">Get the latest news in your inbox</p>
            </div>
          </div>
          ...
          <div className="mt-auto">
            <div className="input-group mb-3" style={{ height: '55px' }}>
              <input
                type="email"
                className="form-control border-secondary fs-5 py-3" {/* Added py-3 for vertical padding */}
                placeholder="Your email address"
                style={{
                  fontSize: '1.1rem !important', /* Force larger font */
                  paddingLeft: '15px'
                }}
              />
              <button 
    ...
    {/* Right Box: Roadmap - Normal */}
    <div className="col-xxl-4 col-xl-4 col-lg-5"> {/* Smaller column */}
      <div className="card border-warning bg-white h-100" style={{
        ...
        <div className="card-body p-4 d-flex flex-column">
          <div className="d-flex align-items-center mb-4">
            <div className="bg-warning bg-opacity-10 p-3 rounded-circle me-3 d-flex align-items-center justify-content-center" style={{ width: '50px', height: '50px' }}>
          ...
          <div className="mb-4">
            <div className="d-flex align-items-start mb-3">
              <div className="text-warning me-3 mt-1"><i className="bi bi-circle-fill fs-5"></i></div>
              <div>
                <h5 className="fw-bold mb-1 text-black">AI Strategy Builder</h5>
            ...
            <div className="d-flex align-items-start mb-3">
              <div className="text-info me-3 mt-1"><i className="bi bi-circle-fill fs-5"></i></div>
              <div>
                <h5 className="fw-bold mb-1 text-black">Social Trading</h5>
            ...
            <div className="d-flex align-items-start">
              <div className="text-success me-3 mt-1"><i className="bi bi-circle-fill fs-5"></i></div>
              <div>
                <h5 className="fw-bold mb-1 text-black">DeFi Integration</h5>
          ...
          <div className="mt-auto">
            <button className="btn btn-outline-warning w-100 py-2 fs-5">
