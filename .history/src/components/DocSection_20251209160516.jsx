              ...
              {quickLinks.map((link, index) => (
                <div key={index} className="col-6 col-md-4 col-lg-2">
                  <a href={link.link} className="text-decoration-none">
                    <div className={`card border-0 shadow-sm h-100 hover-lift ${link.popular ? 'border-primary border-2' : ''}`}>
                  ...
                  <div className="card border-0 shadow-sm h-100">
                    <div className="card-body p-4">
                      <div className="d-flex align-items-center mb-4">
                        <div className={`bg-${category.color} bg-opacity-10 p-3 rounded-circle me-3`}>
                    ...
                    <div key={index} className="col-md-4">
                      <div className="card border-0 shadow-sm h-100">
                        <div className="card-body p-4">
                          ...
                          <p className="text-muted small mb-4">{guide.description}</p>
              ...
              <div className="col-md-4">
                <div className="card border-0 shadow-sm h-100">
                  <div className="card-body p-4 text-center">
                    ...
                    <p className="text-muted small mb-4">Complete REST API reference with examples</p>
              ...
              <div className="col-md-4">
                <div className="card border-0 shadow-sm h-100">
                  <div className="card-body p-4 text-center">
                    ...
                    <p className="text-muted small mb-4">Official SDKs for Python, JavaScript, and more</p>
              ...
              <div className="col-md-4">
                <div className="card border-0 shadow-sm h-100">
                  <div className="card-body p-4 text-center">
                    ...
                    <p className="text-muted small mb-4">Command-line interface for advanced users</p>
