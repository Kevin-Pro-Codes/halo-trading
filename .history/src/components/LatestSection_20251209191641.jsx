...
<div className="row justify-content-center mt-5">
  <div className="col-lg-10">
    <div className="row g-4 d-flex align-items-stretch"> {/* Added align-items-stretch */}
      
      {/* Left Box: Newsletter */}
      <div className="col-lg-6 d-flex"> {/* Added d-flex */}
        <div className="card border-primary bg-white w-100"> {/* Added w-100 */}
          <div className="card-body p-4 d-flex flex-column h-100"> {/* Added h-100 */}
      ...
      {/* Right Box: Roadmap */}
      <div className="col-lg-6 d-flex"> {/* Added d-flex */}
        <div className="card border-warning bg-white w-100"> {/* Added w-100 */}
          <div className="card-body p-4 d-flex flex-column h-100"> {/* Added h-100 */}
            {/* ... rest of your content ... */}
          </div>
        </div>
