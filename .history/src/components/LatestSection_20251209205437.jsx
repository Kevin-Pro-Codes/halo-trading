...
{/* Two Boxes at Bottom - TOUCHING EACH OTHER */}
<div style={{
  width: '100%',
  marginTop: '3rem',
  marginBottom: '2rem'
  ...
  <div style={{
    ...
    <div style={{  
      flex: 1,
      minWidth: '1000px',  // CRITICAL: Allow shrinking below min-content
      marginRight: '-1px'  // Make them touch by overlapping border
    }}>
       <div className="card border-warning bg-white" style={{
        minHeight: '380px',
        borderRadius: '10px',
        borderRight: 'none',  // Remove right border where cards touch
    ...
    <div style={{
      flex: 1,
      minWidth: '0'  // CRITICAL: Allow shrinking below min-content
    }}>
      <div className="card border-warning bg-white" style={{
        minHeight: '380px',
        borderRadius: '10px',
        borderLeft: 'none',  // Remove left border where cards touch
