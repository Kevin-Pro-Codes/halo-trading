        ...
        <div className="card border-warning bg-white h-100">
          <div className="card-body p-3 p-lg-4 d-flex flex-column">
            ...
            <div className="d-flex align-items-center mb-3">
              ...
              <div>
                <h4 className="fw-bold mb-1 text-black fs-5 fs-lg-4">
                  What's Coming Next
                </h4>
              ...
              <div className="d-flex align-items-start mb-3">
                ...
                <div>
                  ...
                  <p className="text-black small mb-0">
                    Create custom trading strategies with AI assistance
                  </p>
                  <small className="text-warning">
                    <i className="bi bi-calendar me-1"></i> Q3 2025
                  </small>
                </div>
              </div>
              ...
              <div className="d-flex align-items-start mb-3">
                ...
                <div>
                  ...
                  <small className="text-info">
                    <i className="bi bi-calendar me-1"></i> Q4 2025
                  </small>
                </div>
              </div>
              ...
              <div className="d-flex align-items-start">
                ...
                <div>
                  ...
                  <small className="text-success">
                    <i className="bi bi-calendar me-1"></i> Q1 2026
                  </small>
                </div>
              </div>
