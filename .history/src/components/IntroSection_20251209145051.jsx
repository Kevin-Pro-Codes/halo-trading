  ...
  return (
    <section className="bg-black text-white overflow-hidden">
      <div className="container py-5">
        ...
        {/* Centered Interactive Test - Compact Version */}
        <div className="row justify-content-center">
          <div className="col-sm-6 col-md-5 col-lg-4">
            <div className="bg-dark border-primary border-2 rounded-3 p-4">
              <div className="text-center">
                <h6 className="fw-bold text-white mb-2">Quick Interaction Test</h6>
                <p className="text-white-50 small mb-3">Click to test interactive functionality</p>
                
                <div className="mb-3">
                  <button 
                    onClick={() => setCount(count + 1)}
                    className="btn btn-primary btn-lg w-100 py-3 fw-bold position-relative"
                  >
                    <i className="fas fa-mouse-pointer me-2"></i>
                    Count: 
                    <span className="badge bg-white text-dark ms-2 px-2 py-1">{count}</span>
                  </button>
                </div>
