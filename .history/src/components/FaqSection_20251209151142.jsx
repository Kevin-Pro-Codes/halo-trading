...
{/* CTA Section - With Side Margins */}
<div className="row justify-content-center mt-5">
  <div className="col-lg-10 col-xl-8">
    <div className="card border-primary bg-primary bg-opacity-5 mx-2 mx-md-3 mx-lg-0">
      <div className="card-body p-4 p-md-5">
        <div className="text-center mb-4">
          ...
          <p className="text-muted mb-4 mx-2 mx-md-3 mx-lg-4">
            Can't find the answer? Our support team is here to help.
          </p>
        </div>
        
        <div className="d-flex flex-column flex-md-row justify-content-center align-items-center gap-2 gap-md-3 mb-4 mx-2 mx-md-3 mx-lg-4">
          <button className="btn btn-outline-secondary btn-lg px-3 px-md-4 py-2 py-md-3 flex-fill flex-md-grow-0">
        ...
        <div className="text-center mt-4 mx-2 mx-md-3 mx-lg-4">
