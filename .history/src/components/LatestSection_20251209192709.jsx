...
const LatestSection = () => {
  ...
  return (
    <section className="py-5 bg-dark text-white">
      {/* 🟢 CHANGE APPLIED HERE: Changed "container" to "container-fluid" for maximum horizontal size */}
    ...
    {/* Two Boxes at Bottom - Adjusted for wider size */}
<div className="row justify-content-center mt-5">
  <div className="col-xxl-11 col-lg-12"> {/* Uses the maximum width of the new container-fluid parent */}
    <div className="row g-4">
