...
const LatestSection = () => {
  ...
  return (
    <section className="py-5 bg-dark text-white">
     ...
     {/* TWO BOTTOM BOXES (FIXED ALIGNMENT) */}
  ...
  <div className="col-12 col-lg-10">
    <div className="row g-3 g-lg-4">
      ...
      <div className="col-12 col-lg-6">
        <div className="card border-warning bg-white w-500 h-100">
          <div className="card-body p-3 p-lg-4 d-flex flex-column">
            ...
            <div className="mt-auto">
              <div className="input-group mb-2 mb-lg-3">
                <input type="email" className="form-control border-secondary" placeholder="Your email address"/>
                <button className="btn btn-primary">Subscribe</button>
              </div>

              <small className="text-black">
                <i className="bi bi-shield-check me-1"></i> We respect your privacy. Unsubscribe anytime.
              </small>
          ...
          <div className="card-body p-3 p-lg-4 d-flex flex-column">
            ...
            <div className="mb-3 mb-lg-4 flex-grow-1">
              <div className="d-flex align-items-start mb-3">
                <div className="text-warning me-3 mt-1"><i className="bi bi-circle-fill small"></i></div>
                <div>
              ...
              <div className="d-flex align-items-start mb-3">
                <div className="text-info me-3 mt-1"><i className="bi bi-circle-fill small"></i></div>
                <div>
              ...
              <div className="d-flex align-items-start">
                <div className="text-success me-3 mt-1"><i className="bi bi-circle-fill small"></i></div>
                <div>
