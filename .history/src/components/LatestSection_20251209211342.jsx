  ...
  return (
    <section className="py-5 bg-dark text-white">
      <div className="container">
        ...
        {/* Two Boxes at Bottom - RESPONSIVE */}
        <div className="row justify-content-center mt-4 mt-lg-5">
          <div className="col-12 col-lg-10">
            <div className="row g-3 g-lg-4">
              
              {/* Left Box: Newsletter */}
              <div className="col-12 col-lg-7 w-500">
                <div className="card border-warning bg-white h-100 w-500">
                  <div className="card-body p-3 p-lg-4 d-flex flex-column w-500">
                    <div className="d-flex align-items-center mb-3 w-500">
                      <div className="bg-primary bg-opacity-10 p-2 rounded-circle me-3 w-500">
                        <i className="bi bi-bell-fill text-black fs-4 w-500"></i>
                      </div>
                      <div>
