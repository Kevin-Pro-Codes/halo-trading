  ...
  return (
    <section className="py-5 bg-light">
      <div className="container">
        ...
        {/* Featured Guides - FIXED layout */}
<div className="row justify-content-center mb-5">
  <div className="col-12">
    <div className="card border-primary bg-primary bg-opacity-10">
      <div className="card-body p-4">
        {/* Header - Center aligned for better appearance */}
        ...
        <div className="row g-3">
          {featuredGuides.map((guide, index) => (
            <div key={index} className="col-12 col-md-6 col-lg-4 mb-3 mb-md-0">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body p-4">
                  {/* Badge and Views */}
                  <div className="d-flex justify-content-between align-items-start mb-3">
                    <span className={`badge ${
                      guide.difficulty === 'Beginner' ? 'bg-success bg-opacity-10 text-success' :
                      guide.difficulty === 'Intermediate' ? 'bg-warning bg-opacity-10 text-warning' : 
