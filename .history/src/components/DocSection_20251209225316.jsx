...
<div className="row justify-content-center mb-4"> {/* Reduced from mb-5 to mb-4 */}
  <div className="col-lg-10">
    <h4 className="fw-bold text-center mb-3">Quick Access</h4> {/* Added mb-3 */}
    <div className="row g-3">
        ...
        <div key={index} className="col-6 col-md-4 col-lg-2">
          <a href={link.link} className="text-decoration-none">
            <div className={`card border-0 shadow-sm h-100 transition ${link.popular ? 'border-primary border-2' : ''}`}>
              <div className="card-body text-center p-3"> {/* Added p-3 for consistent padding */}
                ...
                <div className="fw-bold small mb-1">{link.title}</div> {/* Added mb-1 */}
                {link.popular && (
