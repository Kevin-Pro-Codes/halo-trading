...
{/* Two Boxes at Bottom - Wider and Closer */}
<div className="row justify-content-center mt-5">
  <div className="col-xxl-10 col-xl-11 col-lg-12 mx-auto">
    <div className="row g-3 justify-content-center">

      {/* Left Box: Newsletter */}
      <div className="col-lg-6 col-3xl-55">
        <div className="card border-primary bg-white h-100 shadow-sm" style={{ borderRadius: "7px" }}>
      ...
      <div className="col-lg-6 col-xl-5">
        <div className="card border-warning bg-white h-100 shadow-sm" style={{ borderRadius: "7px" }}>
          <div className="card-body p-4 d-flex flex-column">
