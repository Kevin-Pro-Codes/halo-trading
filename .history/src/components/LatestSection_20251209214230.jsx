...
const LatestSection = () => {
  ...
  alignItems: "flex-start",
        ...
        borderRadius: '10px'
                  ...
                  <div className="card-body p-3 p-lg-4 d-flex flex-column text-center align-items-center justify-content-center">

                    <div className="d-flex align-items-center mb-3">
                      <div className="bg-warning bg-opacity-10 p-2 rounded-circle me-0">
                        <i className="bi bi-map text-warning fs-4"></i>
                      </div>
                      <div>
                        <h4 className="fw-bold mb-1 text-black fs-5 fs-lg-4 text-center align-items-center justify-content-center">What's Coming Next</h4>
