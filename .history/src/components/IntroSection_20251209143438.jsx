      ...
      <div className="container py-5">
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 mb-5 mb-lg-0">
            ...
            <div className="card bg-dark border-primary border-2">
              <div className="card-body p-4">
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    <h6 className="fw-bold text-white mb-1">Quick Interaction Test</h6>
                    <p className="text-white-50 small mb-0">Click to test interactive functionality</p>
                  </div>
                  <button 
