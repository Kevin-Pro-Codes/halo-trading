...
{/* Two Boxes at Bottom - USING BOOTSTRAP GRID FOR CLOSE SPACING */}
<div className="row justify-content-center mt-4 px-0 mx-0">
  <div className="col-lg-10 px-0">
    <div className="row g-2 mx-0"> {/* Reduced gap to g-2 for very close spacing */}
      
      {/* Left Box: Newsletter */}
      <div className="col-lg-7 px-2"> {/* Added px-2 for small side padding */}
        <div className="card border-warning bg-white h-100">
          <div className="card-body p-4 d-flex flex-column">
            ...
            <p className="text-black mb-3 flex-grow-1">
      ...
      {/* Right Box: Roadmap */}
      <div className="col-lg-5 px-2"> {/* Added px-2 for small side padding */}
        <div className="card border-warning bg-white h-100">
          <div className="card-body p-4 d-flex flex-column">
            <div className="d-flex align-items-center mb-3">
            ...
            <div className="mb-3 flex-grow-1">
              <div className="d-flex align-items-start mb-2">
                <div className="text-warning me-2 mt-1"><i className="bi bi-circle-fill small"></i></div>
                <div>
              ...
              <div className="d-flex align-items-start mb-2">
                <div className="text-info me-2 mt-1"><i className="bi bi-circle-fill small"></i></div>
                <div>
              ...
              <div className="d-flex align-items-start">
                <div className="text-success me-2 mt-1"><i className="bi bi-circle-fill small"></i></div>
                <div>
      ...
      <style jsx>{`
        ...
        /* For even closer spacing between the two bottom cards */
        .row.g-2 > [class*='col-'] {
