          ...
          <div className="col-lg-6">
            <div className="card bg-dark border-primary border-2 mb-0">
              <div className="card-body p-4">
                <h6 className="fw-bold text-white mb-0">Quick Interaction Test</h6>
                <p className="text-white-50 small mb-0">Click the button to test interactive functionality</p>
                
                <button 
                  onClick={() => setCount(count + 1)}
                  className="btn btn-primary btn-lg px-4 py-0 fw-bold mb-0"
                >
