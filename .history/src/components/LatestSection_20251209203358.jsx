...
{/* Two Boxes at Bottom - FIXED TO ACTUALLY BE BIGGER */}
<div style={{
  width: '100vw',
  ...
  <div style={{
    ...
    {/* Left Box: Newsletter - ACTUALLY BIGGER */}
    <div style={{
      flex: 'none', // Changed from '1' to 'none' - won't shrink
      width: '1000px', // Fixed width instead of minWidth
      backgroundColor: 'transparent'
    }}>
      <div className="card border-primary bg-white" style={{
        ...
        <div className="card-body p-0 d-flex flex-column">
          <div className="d-flex align-items-center mb-5">
            <div className="bg-primary bg-opacity-10 rounded-circle p-4 me-4 d-flex align-items-center justify-content-center" style={{ 
              width: '90px', 
              height: '90px',
              minWidth: '90px' // Prevents shrinking
            }}>
              <i className="bi bi-bell-fill text-black" style={{ fontSize: '2.5rem' }}></i>
            </div>
            <div style={{ flex: '1' }}>
              <h1 className="fw-bold mb-3 text-black" style={{ fontSize: '2.8rem', lineHeight: '1.2' }}>Stay Updated</h1>
              <p className="text-black mb-0" style={{ fontSize: '1.5rem' }}>Get the latest news in your inbox</p>
            </div>
          </div>

          <p className="text-black mb-5" style={{ 
            fontSize: '1.4rem',
            lineHeight: '1.6'
          }}>
          ...
          <div className="mt-auto">
            <div className="input-group mb-4" style={{ height: '80px' }}>
              <input
                type="email"
            ...
            <p className="text-black mb-0" style={{ fontSize: '1.2rem' }}>
      ...
      <div className="card border-warning bg-white" style={{
        ...
        <div className="card-body p-4 d-flex flex-column">
          <div className="d-flex align-items-center mb-4">
            <div className="bg-warning bg-opacity-10 p-3 rounded-circle me-3 d-flex align-items-center justify-content-center" style={{ 
              width: '60px', 
              height: '60px',
              minWidth: '60px'
            }}>
              <i className="bi bi-map text-warning" style={{ fontSize: '1.5rem' }}></i>
            </div>
            <div>
          ...
          <div className="mt-auto">
            <button className="btn btn-outline-warning w-100 py-3 fs-5">
