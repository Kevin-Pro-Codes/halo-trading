...
<div style={{
  ...
  <div style={{
    display: 'grid',
    gridTemplateColumns: '2.5fr 1fr', // Left takes 2.5x more space
    gap: '40px',
    width: '100%'
  }}>
    
    {/* Left Box - Takes 71% of space */}
    <div style={{ width: '100%' }}>
      <div style={{ 
        width: '100%',
        transform: 'scale(1.1)', // Actually makes it bigger visually
