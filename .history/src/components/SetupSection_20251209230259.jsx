            ...
            <div className="bg-dark bg-opacity-50 border border-secondary rounded-3 p-4">
              <div className="row align-items-center">
                <div className="col-md-8">
                  ...
                  <p className="text-white-50 mb-3">Follow these 6 simple steps to start automated trading</p> {/* Updated to 6 steps */}
                  ...
                  <small className="text-white-50">
                    ...
                    Average setup time: 41 minutes {/* Updated time */}
                  </small>
                </div>
          ...
          <div className="col-lg-10">
            <div className="row g-4">
              {setupSteps.map((step, index) => (
                <div key={step.id} className="col-md-6 col-lg-4"> {/* Changed to show 3 per row on large screens, 2 per row on medium */}
                ...
                <div className="card border-primary bg-dark h-100 d-flex flex-column">
                  <div className="card-body p-4">
                    <div className="d-flex align-items-center mb-3">
                      <div className="bg-primary bg-opacity-10 p-2 rounded-circle me-3">
                        <i className="bi bi-play-btn text-primary fs-4"></i>
                      </div>
                      <div>
                        <h5 className="fw-bold mb-0">Video Tutorial</h5>
                    ...
                    <div className="bg-dark border border-secondary rounded-2 p-3 mb-3 text-center">
                      <i className="bi bi-play-circle text-white-50 fs-1"></i>
                      <p className="text-white-50 small mt-2">Click to play setup tutorial</p>
                    </div>
