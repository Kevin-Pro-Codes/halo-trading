...
>
  ...
  <span className="ms-0">{category.name}</span>
       ...
       {/* Stats */}
<div className="row justify-content-center mt-5 mb-0"> {/* Changed mb-5 to mb-0 */}
  <div className="col-sm-7">
    <div className="row g-3"> {/* Reduced g-4 to g-3 */}
      <div className="col-md-4 text-center">
        <div className="card border-0 shadow-sm mb-0"> {/* Added mb-0 to card */}
          <div className="card-body p-3"> {/* Reduced p-4 to p-3 */}
            ...
            <h3 className="fw-bold mb-1">24/7 Support</h3>
            <p className="text-muted">Round-the-clock assistance for all users</p>
          </div>
        </div>
      </div>
      {/* Apply same changes to other cards */}
    </div>
  </div>
</div>
