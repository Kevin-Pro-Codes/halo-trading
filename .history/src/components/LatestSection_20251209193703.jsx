  ...
  <div className="col-xxl-10 col-xl-11 col-lg-12 mx-auto">
    <div className="row g-3 justify-content-center">
      ...
      <div className="col-lg-6 col-xl-5">
        <div className="card border-primary bg-white h-100 shadow-sm" style={{ borderRadius: "18px" }}>
      ...
      {/* Right Box: Roadmap */}
      <div className="col-lg-6 col-xl-5">
        <div className="card border-warning bg-white h-100 shadow-sm" style={{ borderRadius: "18px" }}>
          <div className="card-body p-4 d-flex flex-column">
