...
<div className="row justify-content-center mt-5 mb-5">
  <div className="col-sm-7">
    <div className="row g-4">
      ...
      {/* Card 3 - 2 Min Response (Blue Outlined Button Style) */}
      <div className="col-md-4 text-center">
        <button 
          className="btn btn-outline-primary border-2 shadow-sm w-100 h-100 p-0 d-block"
          style={{backgroundColor: 'transparent'}}
          onClick={() => console.log('Response time card clicked')}
        >
          <div className="p-4">
            <div className="bg-primary bg-opacity-10 p-3 rounded-circle d-inline-block mb-3">
              <i className="bi bi-lightning text-primary fs-4"></i>
            </div>
            <h3 className="fw-bold mb-2 text-dark">2 Min Response</h3>
...
<div className="row justify-content-center mt-4">
  <div className="col-lg-11 col-xl-10">  {/* WIDER */}
    <div className="card border-primary bg-white bg-opacity-5">
