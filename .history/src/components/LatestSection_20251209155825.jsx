            ...
            <div className="row g-4">
              {updates.map((update) => (
                <div key={update.id} className="col-md-6 col-lg-4">
                  <div className="card h-100 border-secondary bg-dark hover-lift transition-all">
                    <div className="card-body p-4">
                      ...
                      <h4 className="fw-bold mb-3 text-white">{update.title}</h4>
                      <p className="text-white-50 mb-4">{update.description}</p>
                    ...
                    {/* Card Footer */}
                    <div className="card-footer bg-dark border-top border-secondary pt-0">
          ...
          <div className="col-lg-10">
            <div className="row g-4">
              ...
              <div className="col-lg-6">
                <div className="card border-primary bg-white h-100">
                  <div className="card-body p-4 d-flex flex-column">
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div>
                        <h4 className="fw-bold mb-1 text-white">Stay Updated</h4>
                        <p className="text-white-50 small mb-0">Get the latest news in your inbox</p>
                      </div>
                    </div>
                ...
                <div className="card border-warning bg-dark h-100">
                  <div className="card-body p-4 d-flex flex-column">
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div>
                        <h4 className="fw-bold mb-1 text-white">What's Coming Next</h4>
                        <p className="text-white-50 small mb-0">Upcoming features roadmap</p>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      <div className="d-flex align-items-start mb-3">
                        ...
                        <div>
                          <h6 className="fw-bold mb-1 text-white">AI Strategy Builder</h6>
                          <p className="text-white-50 small mb-0">Create custom trading strategies with AI assistance</p>
                      ...
                      <div className="d-flex align-items-start mb-3">
                        ...
                        <div>
                          <h6 className="fw-bold mb-1 text-white">Social Trading</h6>
                          <p className="text-white-50 small mb-0">Follow top traders and copy their strategies</p>
                      ...
                      <div className="d-flex align-items-start">
                        ...
                        <div>
                          <h6 className="fw-bold mb-1 text-white">DeFi Integration</h6>
                          <p className="text-white-50 small mb-0">Connect with decentralized finance protocols</p>
