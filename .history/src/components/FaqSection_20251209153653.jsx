    ...
    <div className="row g-3"> {/* Reduced gap from g-4 to g-3 */}
      <div className="col-md-4 text-center">
        <div className="card border-0 shadow-sm h-100">
          <div className="card-body p-3"> {/* Reduced padding from p-4 to p-3 */}
            <div className="bg-primary bg-opacity-10 p-2 rounded-circle d-inline-block mb-2"> {/* Reduced p-3 to p-2 */}
              <i className="bi bi-headset text-primary fs-5"></i> {/* Reduced fs-4 to fs-5 */}
            </div>
            <h4 className="fw-bold mb-1">24/7 Support</h4> {/* Changed from h3 to h4, reduced mb-2 to mb-1 */}
            <p className="text-muted small mb-0">Round-the-clock assistance for all users</p> {/* Added small class */}
          </div>
        </div>
      </div>
      <div className="col-md-4 text-center">
        <div className="card border-0 shadow-sm h-100">
          <div className="card-body p-3">
            ...
            <h4 className="fw-bold mb-1">98% Satisfaction</h4>
            <p className="text-muted small mb-0">Based on user feedback and reviews</p>
          </div>
        </div>
      </div>
      <div className="col-md-4 text-center">
        <div className="card border-0 shadow-sm h-100">
          <div className="card-body p-3">
            ...
            <h4 className="fw-bold mb-1">2 Min Response</h4>
            <p className="text-muted small mb-0">Average live chat response time</p>
          </div>
        </div>
      </div>
    </div>
