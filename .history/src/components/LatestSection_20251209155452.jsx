  ...
  return (
    <section className="py-5 bg-light">
      <div className="container">
        ...
        {/* Two Boxes at Bottom - Side by Side */}
          ...
          <div className="col-lg-10">
            <div className="row g-4">
              ...
              <div className="col-lg-6">
                <div className="card border-primary bg-primary bg-opacity-5 h-100">
                  <div className="card-body p-4 d-flex flex-column">
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div>
                        <h4 className="fw-bold mb-1">Stay Updated</h4>
                        <p className="text-muted small mb-0">Get the latest news in your inbox</p>
                      </div>
                    </div>
              ...
              {/* Right Box: Roadmap */}
              <div className="col-lg-6">
                <div className="card border-warning bg-warning bg-opacity-5 h-100">
                  <div className="card-body p-4 d-flex flex-column">
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div>
                        <h4 className="fw-bold mb-1">What's Coming Next</h4>
                        <p className="text-muted small mb-0">Upcoming features roadmap</p>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      <div className="d-flex align-items-start mb-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted small mb-0">Create custom trading strategies with AI assistance</p>
                      ...
                      <div className="d-flex align-items-start mb-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted small mb-0">Follow top traders and copy their strategies</p>
                      ...
                      <div className="d-flex align-items-start">
                        ...
                        <div>
                          ...
                          <p className="text-muted small mb-0">Connect with decentralized finance protocols</p>
