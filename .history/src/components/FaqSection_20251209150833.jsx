            ...
            <div className="card border-primary bg-primary bg-opacity-5">
              <div className="card-body p-4 p-md-5">
                ...
                <div className="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3 mb-4">
                  <button className="btn btn-primary btn-lg px-4 py-3 d-flex align-items-center justify-content-center" style={{ minWidth: '180px' }}>
                    <i className="bi bi-chat-dots me-2"></i>
                    <span>Start Live Chat</span>
                  </button>
                  <button className="btn btn-outline-primary btn-lg px-4 py-3 d-flex align-items-center justify-content-center" style={{ minWidth: '180px' }}>
                    <i className="bi bi-envelope me-2"></i>
                    <span>Contact Support</span>
                  </button>
                  <button className="btn btn-outline-secondary btn-lg px-4 py-3 d-flex align-items-center justify-content-center" style={{ minWidth: '180px' }}>
                ...
                <div className="text-center mt-4">
                  <small className="text-muted">
                    ...
                    Call us at 1-800-TRADE-BOT • Available 24/7
                  </small>
                </div>
              </div>
            </div>
