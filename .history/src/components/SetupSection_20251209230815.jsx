  ...
  return (
    <section className="py-5 bg-dark text-white">
      <div className="container">
            ...
            <div className="bg-dark bg-opacity-50 border border-secondary rounded-3 p-4">
              <div className="row align-items-center">
                <div className="col-md-8">
                  ...
                  <p className="text-white-50 mb-3">Follow these 6 simple steps to start automated trading</p>
        ...
        {/* Setup Steps - ALIGNED GRID - CENTERED CONTENT */}
        <div className="row justify-content-center mb-5">
          <div className="col-lg-10">
        ...
        {/* Setup Help & Support - ALIGNED - CENTERED CONTENT */}
        <div className="row justify-content-center mb-5">
          <div className="col-lg-10">
            <div className="row g-4">
              {/* Video Tutorial */}
              <div className="col-md-6">
                <div className="card border-primary bg-dark h-100 d-flex flex-column">
                  <div className="card-body p-4 text-center d-flex flex-column">
                    ...
                    <div className="bg-dark border border-secondary rounded-2 p-3 mb-4">
                      <i className="bi bi-play-circle text-white-50 fs-1 mb-2 d-block"></i>
                      <p className="text-white-50 small mb-0">Click to play setup tutorial</p>
                    </div>
        ...
        {/* Quick Start Tips - CENTERED CONTENT */}
