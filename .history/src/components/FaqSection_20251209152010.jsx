...
{/* CTA Section - Super Short Vertically */}
      ...
      <div className="card-body p-2 p-md-3">  
        ...
        <div className="text-center mb-2">
          <div className="bg-primary bg-opacity-10 p-1 rounded-circle d-inline-block mb-1">
            <i className="bi bi-question-circle-fill text-primary fs-5"></i>
          </div>
        ...
        <div className="d-flex flex-column flex-md-row justify-content-center align-items-center gap-1 mb-2">
          <button className="btn btn-outline-secondary px-3 py-1 small">
